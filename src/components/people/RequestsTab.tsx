...
export default function RequestsTab({ initialUser }: RequestsTabProps) {
    ...
    if (requestsLoading && !hasRequests) {
        return (
            ...
            {incomingRequests.length > 0 && (
                <div>
                    <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-4 flex items-center gap-2">
                        ...
                        Incoming Requests
                        <span className="ml-1 px-2 py-0.5 text-xs font-medium bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-full">
            ...
            {sentRequests.length > 0 && (
                <div>
                    <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-4 flex items-center gap-2">
                        ...
                        <span className="ml-1 px-2 py-0.5 text-xs font-medium bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400 rounded-full">
                            {sentRequests.length}
                        </span>
                    </h2>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
