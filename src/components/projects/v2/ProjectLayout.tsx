                        ...
                        <div className="flex items-center gap-4 min-w-0">
                            ...
                            <div className="flex items-center gap-3 min-w-0">
                                ...
                                <div className="hidden md:flex items-center gap-1 text-xs text-zinc-500 dark:text-zinc-400 min-w-0">
                                    ...
                                    {project?.owner?.canOpenProfile ? (
                                        <Link
                                            href={`/u/${project.owner.username}`}
                                            className="font-medium text-primary hover:underline truncate max-w-[180px]"
                                            title={project?.owner?.displayName || project?.owner?.fullName || project?.owner?.username || "Creator"}
                                        >
                                            {project?.owner?.displayName || project?.owner?.fullName || project?.owner?.username || "Creator"}
                                        </Link>
                                    ) : (
                                        <span
                                            className="truncate max-w-[180px] font-medium text-zinc-700 dark:text-zinc-300"
                                            title={project?.owner?.displayName || "Private creator"}
                                        >
                                            {project?.owner?.displayName || "Private creator"}
                                        </span>
                                    )}
                                </div>
