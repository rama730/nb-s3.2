...
export function BreadcrumbBar({
  ...
  return (
    <nav
      ...
      className="flex items-center gap-0.5 text-xs text-zinc-600 dark:text-zinc-300 overflow-x-auto h-8 px-2 select-none border-b border-zinc-200 dark:border-zinc-800"
