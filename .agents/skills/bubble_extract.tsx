                                    ...
                                    className={cn(
                                        ...
                                        (onlyEmojis || isApplication || isCodeOnlyContent) ? '!bg-transparent !bg-none !border-0 !shadow-none !p-0' : cn(
                                            isOwn ? (
                                                cn(
                                                    'rounded-2xl',
                                                    isConsecutiveFromPrev && 'rounded-tr-sm',
                                                    isConsecutiveToNext && 'rounded-br-sm'
                                                )
                                            ) : (
                                                cn(
                                                    'rounded-2xl',
                                                    isConsecutiveFromPrev && 'rounded-tl-sm',
                                                    isConsecutiveToNext && 'rounded-bl-sm'
                                                )
                                            ),
